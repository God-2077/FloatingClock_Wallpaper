...
> **TIP:** If you want to create a wallpaper using the Wallpaper Engine editor, you should instead look at the documentation for Scene wallpapers.
...
**Next:** [Creating a Web Wallpaper](gettingstarted.md)
